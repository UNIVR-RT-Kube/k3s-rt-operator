...
import (
	...
	"github.com/francescol96/monitorrt/controllers"
...
func main() {
	...
	opts := zap.Options{
		Development: true,
		Level:       zapcore.Level(0), // Set this value to level -3 to show debug information or 0 to show info only
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "32a52a00.francescol96.univr",
	})
	if err != nil {
